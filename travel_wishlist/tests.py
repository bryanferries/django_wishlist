...
from .models import Place
                                # Tests to see if the code is working; 1st test to see if the correct response for an empty list is given
...
class TestWishList(TestCase):
                                    # Test to see if the code is correct for places not visited on the wishlist page
...
class TestVisitedPage(TestCase):
                                    # Tests the visited page if it gives the correct response if it's empty
